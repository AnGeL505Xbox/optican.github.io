window.onload = () => {
    ...
    var sintomasCovid = {
        a: [
            "Fiebre", "Tos seca", "Cansancio", "Perdida del gusto/olfato"
        ],
        b: [
            "Dolor de cabeza", "Dolor de garganta", "Malestar fisico", "Diarrea", "Ojos irritados"
        ],
        c: [
            "Dificultad respirar", "Dolor de pecho", "Confusion"
        ]
    };
